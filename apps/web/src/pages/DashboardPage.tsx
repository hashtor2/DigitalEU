...
function ProtonBanner({ hasEmail, hasCloud }: { hasEmail: boolean; hasCloud: boolean }) {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-sky-500/20 bg-gradient-to-r from-sky-950/40 via-slate-900/60 to-slate-950/40 p-6 sm:p-8">
        ...
        <div className="flex shrink-0 flex-col gap-2 sm:items-end">
          {hasEmail && (
            <a
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-sky-500 px-5 py-2.5 text-sm font-bold text-white shadow-lg shadow-sky-500/20 transition hover:bg-sky-400 active:scale-95"
            >
          ...
          {hasCloud && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 rounded-xl border border-sky-500/30 bg-sky-500/10 px-5 py-2.5 text-sm font-bold text-sky-300 transition hover:bg-sky-500/20"
            >
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <main className="mx-auto max-w-7xl px-4 py-10 sm:px-6 space-y-8">
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-5">
          ...
          <div className="rounded-xl border border-emerald-500/20 bg-emerald-500/5 p-4 text-center col-span-2 sm:col-span-1">
            <p className="text-2xl font-extrabold text-emerald-400">{migratedCount}/{sorted.length}</p>
