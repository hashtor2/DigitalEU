...
function matchDomain(domain) {
    ...
    if (parts.length > 2) {
        ...
        if (rootHit)
            return { serviceId: rootHit, confidence: "medium" };
    }
    return null;
}
...
export function matchEntries(rawEntries, sourceType) {
