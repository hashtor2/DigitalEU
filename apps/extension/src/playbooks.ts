...
import type { PlaybookStep, GuideType } from "@digitaleu/shared";

export interface SitePlaybook {
  serviceId: string;
  serviceName: string;
  loginUrl: string;
  guides: Partial<Record<GuideType, PlaybookStep[]>>;
}

export const PLAYBOOK_REGISTRY: SitePlaybook[] = [
  {
    serviceId: "netflix",
    serviceName: "Netflix",
...
export function getPlaybook(serviceId: string): SitePlaybook | undefined {
