...
- **2026-06-25 (Legal):** Personvernpåstand-revisjon utført — se `docs/legal/CLAIMS_AUDIT_2026-06-25.md` + `docs/legal/LANDING_COPY_CORRECTIONS_2026-06-25.md`. To påstander var ikke lenger bokstavelig sanne: "Switzerland" som *vår* datalokasjon (skal være Sverige), og "100 % client-side"-skanning (live-skanner kjører server-side, ADR #22). Korrigert landingstekst overlevert Lead Engineer.
  - **TODO (Legal/Eng):** "Zero-knowledge" må holdes i fremtidsform i offentlig tekst inntil Profilmodus-ZK faktisk er live i MVP (jf. `README.md:124`, `PROJECT_REPORT.md:911` "not yet in MVP"). Verifiser med Lead Engineer om ZK-profil-sync er live; ellers reframe present-tense "zero-knowledge"-påstander. Hold "zero-knowledge" knyttet **kun** til lagret profildata, aldri til skanningen.
